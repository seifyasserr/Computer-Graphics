...
<canvas id="c" onclick="mouseFunction(event)"></canvas>
<style>
...
function makeInstance(geometry,color, x,z) {
  ...
  var texture = loader.load("box.jpg");
...
<div id="score" style="position:absolute;top: 8px;right: 16px;font-size: 24px; background-color:white;">0</div>
</html>